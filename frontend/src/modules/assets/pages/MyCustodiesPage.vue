...
<template>
  <div class="space-y-6">
    <div class="min-w-0">
      <h2 class="text-[1.75rem] font-bold leading-tight text-brand-text">{{ t('assets.myCustodies.title') }}</h2>
          ...
          <tbody>
            ...
            >
              <td class="whitespace-nowrap border-b border-s-[3px] border-brand-border/80 border-s-transparent px-5 py-3.5 transition-colors duration-150 group-hover:border-s-brand-primary group-hover:bg-[#EDF6F1]">
                <span class="inline-flex items-center rounded-lg border border-brand-border bg-brand-bg px-2.5 py-1 font-mono text-[12px] font-bold tracking-wide text-brand-primary-dark" dir="ltr">{{ custody.custody_number }}</span>
              </td>
              ...
              <td class="border-b border-brand-border/80 px-5 py-3.5 transition-colors duration-150 group-hover:bg-[#EDF6F1]">
                ...
                >
                  <span class="h-1.5 w-1.5 rounded-full" :class="custodyStatusDotClass(custody.status)" />
              ...
              <td class="border-b border-brand-border/80 px-5 py-3.5 text-brand-text transition-colors duration-150 group-hover:bg-[#EDF6F1]">{{ formatDateTime(custody.assigned_at) }}</td>
              <td class="border-b border-brand-border/80 px-5 py-3.5 text-brand-text transition-colors duration-150 group-hover:bg-[#EDF6F1]">{{ formatDateTime(custody.expected_return_at) }}</td>
              <td class="border-b border-brand-border/80 px-5 py-3.5 text-brand-text transition-colors duration-150 group-hover:bg-[#EDF6F1]">{{ formatDateTime(custody.returned_at) }}</td>
            </tr>
          </tbody>
        </table>
        </div>
