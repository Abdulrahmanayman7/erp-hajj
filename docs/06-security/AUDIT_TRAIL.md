...
- Asset / custody lifecycle (**specified** Sprint 015 — not yet implemented): `ASSET_CREATED`, `ASSET_UPDATED`, `ASSET_DELETED`, category events, `ASSET_SENT_TO_MAINTENANCE`, `ASSET_RESTORED`, `ASSET_RETIRED`, `ASSET_DECLARED_LOST`, `ASSET_ASSIGNED`, `ASSET_RETURNED` — see [11-assets-and-custodies/API.md](../09-modules/11-assets-and-custodies/API.md). Authoritative histories: `asset_status_transitions`, `asset_custodies`.
