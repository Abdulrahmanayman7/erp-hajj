...
- Task lifecycle (`TASK_CREATED`, `TASK_UPDATED`, `TASK_ASSIGNED`, `TASK_REASSIGNED`, `TASK_STARTED`, `TASK_PROGRESS_UPDATED`, `TASK_COMPLETED`, `TASK_CANCELLED`, `TASK_DELETED` — specified Sprint 012; see [08-tasks/API.md](../09-modules/08-tasks/API.md)). Authoritative histories: `task_status_transitions`, `task_assignment_history`.
