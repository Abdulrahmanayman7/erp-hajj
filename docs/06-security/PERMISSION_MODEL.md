...
| Tenant settings | `tenant_settings.view` `tenant_settings.update` | **Implemented** Sprint 020 — [15-system-settings/PERMISSIONS.md](../09-modules/15-system-settings/PERMISSIONS.md) (ADR-0016) |
...
- `audit_logs.export` format + endpoint — deferred (ADR-0015).
