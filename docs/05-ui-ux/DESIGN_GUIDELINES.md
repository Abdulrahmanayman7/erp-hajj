...
- Prefer **Drawer** for straightforward create/edit forms (e.g. user account, organization unit, employee, contract draft, meeting draft, decision draft); use full pages for dense matrices (e.g. role permission matrix) or rich timelines (e.g. contract/meeting/decision details). See module UI docs under [docs/09-modules/](../09-modules/), including [07-decisions/UI.md](../09-modules/07-decisions/UI.md).
