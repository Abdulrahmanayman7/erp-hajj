...
> **Status:** Approved — Tenant Foundation (004) + Authentication (005) + Users/RBAC (006) implemented; OrganizationStructure specified (007)
...
│   ├── OrganizationStructure/    # Sprint 007 — specified; not implemented (`organization_units`)
