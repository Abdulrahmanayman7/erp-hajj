...
- **Planned tenant-owned tables** (each specified in its module's `DATA_MODEL.md` when designed): `positions`, `employees` (Sprint 008 — implemented; ADR-0005), `contract_categories`, `contracts`, `contract_status_transitions`, `contract_number_sequences` (Sprint 009 — implemented; ADR-0006), `meetings`, `meeting_*` (Sprint 010 — implemented; ADR-0007), `decision_number_sequences`, `decisions`, `decision_status_transitions` (Sprint 011 — implemented; ADR-0008), `tasks`, `documents`, `warehouses`, `inventory_items`, `inventory_transactions`, `assets`, `custodies`, `notifications`, `tenant_settings`.
