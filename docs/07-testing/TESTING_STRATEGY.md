...
- System Settings (Sprint 020 — **implemented**; ADR-0016): Pest/Vitest matrices in [15-system-settings/TEST_PLAN.md](../09-modules/15-system-settings/TEST_PLAN.md); `TenantSettingsTest` 17/17.
