...
- **Sprint 011 implemented:** Meetings details show **إنشاء قرار** for final recommendations on completed meetings when `decisions.create` is held — conversion is owned by Decisions APIs, not Meetings writes.
