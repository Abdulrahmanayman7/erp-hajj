...
| **Notification** | In-app delivery (ADR-0013) | Notifications (Sprint 016 — **implemented**) |
| **Dashboard** | Operational aggregates / deep-links (ADR-0014) | Dashboard (Sprint 017 — specified); Tasks remain SoR |
