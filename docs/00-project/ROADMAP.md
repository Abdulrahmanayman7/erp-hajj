...
| Sprint 006 — Users / roles / permissions (RBAC) | **Specification complete — implementation pending** |
| Organizational structure → remaining MVP modules | After RBAC implementation |
