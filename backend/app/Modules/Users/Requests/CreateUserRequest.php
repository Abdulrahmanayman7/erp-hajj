...
class CreateUserRequest extends FormRequest
{
    ...
    /**
     * @return array{name: string, email: string, role_ids?: list<int>, send_invite?: bool, temporary_password?: string|null}
     */
    public function validatedPayload(): array
    {
        /** @var array{name: string, email: string, role_ids?: list<int>, send_invite?: bool, temporary_password?: string|null} */
