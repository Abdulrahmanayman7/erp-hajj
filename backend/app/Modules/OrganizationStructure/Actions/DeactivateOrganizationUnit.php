...
final class DeactivateOrganizationUnit
{
    ...
    {
        if ($unit->status === OrganizationUnitStatus::Inactive) {
        ...
        $this->security->record(AuthorizationSecurityEvent::ORGANIZATION_UNIT_DEACTIVATED, [
            'tenant_id' => $tenant->id,
            'actor_id' => $actor->id,
